...
//validate User when login
  validateUser(String usermail, String password) async {
    final List<Map<String, dynamic>> users = await _db.query(
      'user',
      where: 'mail = ? AND password = ?',
      whereArgs: [usermail, password],
    );
    print(users);
    ...
    if (users.isNotEmpty) {
      ...
      // User with matching usermail and password found
...
//checking mail when signin if mail already exists
